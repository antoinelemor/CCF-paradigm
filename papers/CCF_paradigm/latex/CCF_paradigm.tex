...
Temporal analysis of frame dominance reveals significant shifts in the paradigm's composition over the study period (Figure~\ref{fig:temporal_evolution}a). Each year was analyzed independently using the identical four-method composite scoring system (25\% each for information theory, network analysis, causality, and proportional dominance), with dominant frames determined through the 3/4 consensus approach described in the Methods. The scientific frame, which dominated the early period (appearing as dominant in 8 of 9 years during the 1980s), maintains a significant presence through the 1990s (9 of 10 years) and continues to appear frequently in the 2000s (7 of 10 years) and 2010s (5 of 10 years), though its relative importance declines. The economic frame shows remarkable consistency across the entire period, appearing as dominant in 43 of 46 years (93.5\%). The political frame is similarly persistent, achieving dominant status in 42 of 46 years (91.3\%). This reveals a gradual shift from science-centered discourse in the 1980s to a persistent co-dominance of political and economic frames, with science playing a declining but still significant role.

Figure~\ref{fig:temporal_evolution}b illustrates the evolution of the number of frames included in the paradigm over time. Triple-paradigm years (3 frames) represent the most common configuration, occurring in 67.4\% of all years analyzed (31 of 46 years). Dual-paradigm years (2 frames) are relatively rare overall (17.4\%), though they become more frequent after 2020 (3 of 5 years). Quad-paradigm years (4 frames) occur sporadically (13.0\%), appearing in 1981, 1993, 2004, 2012, 2014, and 2024. The only mono-paradigm year was 1978, at the very beginning of climate coverage, and it was scientific. This distribution reveals that Canadian climate discourse has consistently mobilized multiple frames simultaneously, with three frames being the modal configuration across four decades.
